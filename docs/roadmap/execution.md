...
- Further perf tuning surfaces as they appear: TP=8 systematic correctness pass and scheduler-level cleanup against the controller/worker model in `models/qwen3/tp-design.md`.
